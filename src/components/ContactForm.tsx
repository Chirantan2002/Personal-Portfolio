...
const ContactForm = () => {
  ...
  return (
    <div className="conatiner mx-auto mt-8 md:mt-24">
      <div className="flex justify-between items-center w-full">
        <div className="hidden md:block">
          <motion.img
            ...
            src={MemojiSmile.src}
            alt="Memoji"
            className="w-full max-w-[500px] h-auto drop-shadow-lg cursor:grab"
          />
        </div>
        <div className="w-full max-w-xl mx-auto text-slate-900 rounded-2xl p-6 md:p-10 backdrop-blur-md border-2 border-pink-400/40 inset-1 bg-gradient-to-tr from-sky-400 to-emerald-300 shadow-lg md:mr-0">
